...
const Home = () => {
  ...
  return (
    <div className="overflow-hidden pt-16">
      ...
      >
        ...
        <div className="relative z-30 px-4 max-w-6xl mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-4 md:gap-6 mb-12 animate-fadeInUp px-4">
            {[
              { name: "Tech Corp", logo: "https://via.placeholder.com/80x80/7c3aed/ffffff?text=TC" },
              { name: "Innovation Labs", logo: "https://via.placeholder.com/80x80/6366f1/ffffff?text=IL" },
              { name: "Future Systems", logo: "https://via.placeholder.com/80x80/8b5cf6/ffffff?text=FS" },
              { name: "Digital Solutions", logo: "https://via.placeholder.com/80x80/a855f7/ffffff?text=DS" }
            ].map((sponsor, i) => (
              <div key={i} className="glass-effect p-3 md:p-4 rounded-2xl animate-float hover:animate-glow transition-all duration-300 group" style={{animationDelay: `${i * 0.3}s`}}>
                ...
                />
                <p className="text-xs text-purple-200 text-center mt-2 font-medium">{sponsor.name}</p>
              </div>
            ))}
          </div>
          ...
          <div className="animate-fadeInUp mb-12" style={{animationDelay: '1.2s'}}>
            <div className="glass-dark p-6 rounded-2xl max-w-2xl mx-auto">
              <h3 className="text-purple-400 font-semibold mb-3">Conference Themes</h3>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {highlights.map((item, index) => (
              ...
              >
                ...
                <div className="text-3xl font-bold gradient-text-purple mb-2">{item.count}</div>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-16 animate-fadeInUp">
            <h2 className="text-4xl font-bold gradient-text-purple relative pb-4 inline-block">
              ...
              <div className="absolute bottom-0 left-1/4 w-1/2 h-1 bg-gradient-to-r from-purple-500 to-violet-600 rounded-full"></div>
            </h2>
          ...
          <div className="bg-white rounded-3xl shadow-2xl overflow-hidden card-hover">
            <div className="p-2 bg-gradient-to-r from-purple-500 to-violet-600">
              <div className="bg-white rounded-2xl p-8 md:p-12">
                <div className="grid md:grid-cols-2 gap-12 items-center">
                  <div className="animate-slideInLeft">
                    <h3 className="text-3xl font-bold gradient-text-purple mb-6">Welcome to ICATES-2025</h3>
                  ...
                  <div className="animate-slideInRight">
                    <div className="grid grid-cols-2 gap-4">
                      {[
                        ...
                        <div key={index} className="bg-gradient-to-br from-purple-50 to-violet-50 p-6 rounded-2xl border border-purple-100 hover:shadow-lg transition-all duration-300">
      ...
      <section id="contact" className="py-20 bg-gradient-to-br from-slate-900 via-purple-900 to-violet-900 text-white relative overflow-hidden z-10">
        <ParticleBackground />
        <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
          <div className="animate-fadeInUp">
            <h2 className="text-4xl font-bold text-purple-200 mb-6">Ready to Join Us?</h2>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-6">
              <Link 
                to="/contact" 
                className="bg-gradient-to-r from-purple-500 to-violet-600 text-white px-10 py-4 rounded-full text-lg font-bold hover:from-purple-600 hover:to-violet-700 transition-all duration-300 transform hover:scale-105 shadow-2xl group"
              >
                Contact Organizers
                <span className="ml-2 transform group-hover:translate-x-1 transition-transform">→</span>
              </Link>
              <button className="bg-gradient-to-r from-indigo-600 to-purple-700 text-white px-10 py-4 rounded-full text-lg font-bold hover:from-indigo-700 hover:to-purple-800 transition-all duration-300 transform hover:scale-105 shadow-2xl group">
                Download Brochure
                <span className="ml-2 transform group-hover:translate-x-1 transition-transform">↓</span>
              </button>
            </div>
